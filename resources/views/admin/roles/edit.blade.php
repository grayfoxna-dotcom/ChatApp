        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">                      
                        <h4 class="card-title">Chỉnh sửa vai trò: {{ $role->display_name }}</h4>                      
                    </div><!--end col-->
                    <div class="col-auto"> 
                ...
                <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label">Mã vai trò (Không thể thay đổi)</label>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-end">
                            <button type="submit" class="btn btn-primary px-4">Cập nhật vai trò</button>
                        </div>
                    </div>
                </form>
            </div><!--end card-body-->
