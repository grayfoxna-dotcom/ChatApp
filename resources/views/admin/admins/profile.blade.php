                ...
                <form id="profileForm" action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-end">
                            <button type="button" class="btn btn-primary px-4" onclick="showConfirmModal()">Cập nhật hồ sơ</button>
                        </div>
                    </div>
                </form>
            </div><!--end card-body-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <p class="mt-3">Bạn có chắc chắn muốn cập nhật hồ sơ cá nhân không?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Hủy bỏ</button>
                <button type="button" class="btn btn-primary btn-sm" onclick="document.getElementById('profileForm').submit();">Xác nhận cập nhật</button>
            </div>
        </div>
    </div>
</div>
